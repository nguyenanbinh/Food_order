                ...
                <div class="col-lg-4 col-sm-8 col-md-6">
                    <div class="fp__footer_content">
                        ...
                        <span>There are many variations of Lorem Ipsum available, but the majority have
                            suffered.</span>
                        <p class="info"><i class="far fa-map-marker-alt"></i> Viet Nam</p>
                        <a class="info" href="callto:1234567890123"><i class="fas fa-phone-alt"></i>
                            +1234-567-890</a>
                        <a class="info" href="mailto:foodorderdemo@gmail.com"><i class="fas fa-envelope"></i>
                            foodorderdemo@gmail.com</a>
                    </div>
                </div>
